...
def main() -> None:
    ...
    # trading_strategy = MinMaxTradingStrategy(min_price=25000, max_price=37000)
    trading_strategy = AverageTradingStrategy(window_size=5)
